...
> Version 3.5.0 | Architecture Multi-Agent Orchestrée | 117+ Agents | Advanced Memory + Orchestration + Workflow + Watchdog + Reporter | Event-Driven | 2026-01-30

---

## 🔴 RESSOURCES IMPORTANTES À CONSULTER

| Ressource | Chemin | Description |
|-----------|--------|-------------|
| **📊 Rapports quotidiens** | `~/Desktop/rapports_aura/{jj-mm-aaaa}/` | Tous les rapports d'actions, erreurs, améliorations |
| **📝 Résumé du jour** | `~/Desktop/rapports_aura/{jj-mm-aaaa}/resume_quotidien.md` | Vue d'ensemble de la journée |
| **🔨 Logs EBP App** | `~/Desktop/rapports_aura/{jj-mm-aaaa}/ebp_app.md` | Builds et améliorations EBP |
...
| 🔴 2 | **JAMAIS BLOQUER LE FEED** | Flux de travail CONTINU - pas d'attente, pas de pause, enchaîner les actions |
| 🔴 3 | **TOUJOURS ORAL + ÉCRIT** | Chaque réponse = `voice_speak.py` + texte (sauf mode OFF) |
| 🔴 4 | **MONITORING TOKENS** | À 95% du contexte → STOP + résumé complet |
| 🔴 5 | **UTILISER LES AGENTS** | Si agent existe → l'utiliser, jamais de bash brut |
| 🔴 6 | **PARALLÉLISER** | Tâches indépendantes → lancer en parallèle |
